...
class TestUserModel(TestCase):
    def test_create_user(self):
        user = User.objects.create_user('tester@gmail.com', name='Test User', password='testpass1')
        self.assertEqual(user.email, 'tester@gmail.com')
        self.assertTrue(user.check_password('testpass1'))

    def test_create_user_without_password(self):
        user = User.objects.create_user('tester@gmail.com', name='Test User', password=None)
        self.assertEqual(user.email, 'tester@gmail.com')
...
class TestCheckEmailView(TestCase):
    ...
    def test_exists(self):
        User.objects.create_user('tester@gmail.com', name='Test User', password='testpass1')
